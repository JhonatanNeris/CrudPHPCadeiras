...
<?php
    ...
    $pdfCadeira->SetY("13");
    $pdfCadeira->Image('imagens/download.jpeg',3,3,15,15);
    $pdfCadeira->Cell(0,5,utf8_decode('Sistema de Cadeiras'),0,1,'R');
    ...
    $busca = mysqli_query($conexao, "SELECT cadID, cadFabricante, cadModelo FROM cadeira");
