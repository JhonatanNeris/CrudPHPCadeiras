...
<table width="60%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td height="60"><div align="center"><font face="Arial" size="4"><b>Gerenciamento de Cadeiras</b></font></div></td>
    </tr>
</table><br>

<?php     
     $sqlCadeira = mysqli_query($conexao,"SELECT cadID, cadFabricante, cadModelo FROM cadeira".
     //Ordena pelo número do código da cadeira
...
?>
        ...
        <tr>
            <td colspan="15"><div align="center"><font face="Arial" size="2"><b>Cadeiras Cadastradas</font></b></font></div></td>
        <tr>
        <td colspan="15"><div align="center"><font face="Arial" size="2"><b>Utilize as Teclas Ctlr+F para Encontrar o Código ou Nome da Cadeira</font></b></font></div></td>
        </tr>
        <tr><td width="5%"><div align="center"><b><font face="Arial" size="2">Código da Cadeira</font></b></div></td>
...
<?php
    ...
    while($arrayCadeira = mysqli_fetch_array($sqlCadeira))
    {
?>
        <tr>
            <td><b><font face="Arial" size="2"><?php echo $arrayCadeira['cadID'];?></font></td>
            <td><b><font face="Arial" size="2"><?php echo $arrayCadeira['cadFabricante'];?></font></td>
            <td><b><font face="Arial" size="2"><?php echo $arrayCadeira['cadModelo'];?></font></td>
        </tr>
<?php
...
<?php
    ...
    {
    echo "<br><br><div align=center><font face=Arial size=2>Desculpe, mais não foi encontrado nenhuma cadeira<br><br></font></div>";
    }
?>
